...
public:
    ...
    // CASES MORTES DE LA LOI DE L'ORDRE (2026-08-03, RESTAURÉ le 2026-08-19) : aplat
    // GRIS sur les cases où une caisse serait condamnée VU DU BUT ACTIF (règle et
    // portée dans game.h). Sert à suivre la loi en direct pendant le rejeu du chemin
    // du solveur — c'est la seule façon de voir POURQUOI elle couperait un état, et
    // de repérer une règle trop mordante avant de la mesurer.
